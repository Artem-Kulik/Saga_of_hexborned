...
var WARDS: Dictionary = {
	...
	"ashayah": {
		...
		"skills": {
			"P": { "id": "ashayah_p", "damage_type": "passive", "name": "Крилатий трофей",    "cd": 0, "icon": "res://Основа/char/air/Ashayah/p.png", "desc": "Перший W: краде по 1 позитивному статусу з кожного ворога.", "desc_full": "При першому використанні Східного вітру Ошая також краде перший позитивний статус кожного ворога (або загиблого від удару). Статус копіюється з повною тривалістю і всіма параметрами. Клятва рицаря дощу — особливий випадок: Ошая стає носієм, хілить водяних союзників, але отримує броню замість HP." },
			"Q": { "id": "ashayah_q", "damage_type": "phys",    "name": "Пікирування",         "cd": 0, "icon": "res://Основа/char/air/Ashayah/q.png", "desc": "60 фіз обраній цілі + 60 фіз рандомній.", "desc_full": "Пікірує на вибраного ворога — 60 фіз. шкоди. Потім б'є 1 випадкового іншого живого ворога — ще 60 фіз. Якщо інших ворогів немає — лише 1 удар." },
			"W": { "id": "ashayah_w", "damage_type": "air",     "name": "Східний вітер",       "cd": 5, "icon": "res://Основа/char/air/Ashayah/w.png", "desc": "30 повітря всім. Знімає по 1 позит. статусу. КД: 5.", "desc_full": "Б'є всіх ворогів — 30 повітря кожному. Знімає по 1 позитивному статусу з кожного (незалежно від виживання). При першому використанні пасивка дозволяє вкрасти ці статуси собі. Перезарядка: 5 ходів." },
			"E": { "id": "ashayah_e", "damage_type": "air",     "name": "Громовий спис",       "cd": 3, "icon": "res://Основа/char/air/Ashayah/e.png", "desc": "1-й раз: 150 повітря цілі + 50 іншим, оглушення 2 ходи. Далі: 50 всім. КД: 3.", "desc_full": "Перше використання: 150 повітря обраній цілі та 50 повітря всім іншим ворогам. Ошая отримує оглушення на 2 ходи. Всі наступні використання: 50 повітря всім ворогам без оглушення. Перезарядка: 3 ходи." },
		}
	},
	"velodiy": {
		"name": "Велодій",
